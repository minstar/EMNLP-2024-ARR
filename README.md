...
4) [LEMMA: Towards LVLM-Enhanced Multimodal Misinformation Detection with External Knowledge Augmentation](https://openreview.net/forum?id=EYKzVrsXPt)
5) [From LLMs to MLLMs: Exploring the Landscape of Multimodal Jailbreaking](https://openreview.net/forum?id=JD6fJzmFfm)
6) [Multimodal Customized Review Generation](https://openreview.net/forum?id=JqC3JoeL3l)
7) [DocEditAgent: Document Structure Editing Via Multimodal LLM Grounding](https://openreview.net/forum?id=KIMkNwkxHX)
8) [Gemini in Reasoning: Unveiling Commonsense in Multimodal Large Language Models](https://openreview.net/forum?id=KdOvmXA1ba)
9) [MM-ChatAlign: A Novel Multimodal Reasoning Framework based on Large Language Models for Entity Alignment](https://openreview.net/forum?id=NUnoxv5Wr0)
10) [Enhance the Robustness in Text-Centric Multimodal Alignments](https://openreview.net/forum?id=PESflaYU8v)
11) [Enhancing Alzheimer’s Disease Diagnosis Records with Large Language Models: A Pipeline for Multimodal and Longitudinal EHRs](https://openreview.net/forum?id=QpHBzKfNd3)
12) [RAGAR, Your Falsehood Radar: RAG-Augmented Reasoning for Political Fact-Checking using Multimodal Large Language Models](https://openreview.net/forum?id=TNOnM4CQsl)
13) [Towards Vision Enhancing LLMs: Empowering Multimodal Knowledge Storage and Sharing in LLMs](https://openreview.net/forum?id=TTQmSmYbwh)
14) [CharacterQA: A Corpus for Multimodal Character Conversational Movie Question Answering](https://openreview.net/forum?id=U5kVVgcSif)
15) [From Traits to Empathy: Personality-Aware Multimodal Empathetic Response Generation](https://openreview.net/forum?id=VnDTbu0WB0)
16) [Palo: A Polyglot Large Multimodal Model for 5B People](https://openreview.net/forum?id=W62WwI6FVl)
17) [Text-Conditioned Multimodal Alignment and Consistency Modeling for Fake News Video Detection](https://openreview.net/forum?id=bb9BBq2oCp)
18) [LLaSA: Large Multimodal Agent for Human Activity Analysis Through Wearable Sensors](https://openreview.net/forum?id=daU3GzIQ58)
19) [VALUE-Bench: A Comprehensive Benchmark for Evaluating Large Vision-Language Models on Multimodal Ethical Understanding](https://openreview.net/forum?id=gmcHqlRC4n)
20) [Fact-Aware Multimodal Retrieval Augmentation for Accurate Medical Radiology Report Generation](https://openreview.net/forum?id=hWxipcH3t9)
21) [Exploring Unified Training Framework for Multimodal User Profiling](https://openreview.net/forum?id=ioC3T9FYAW)
22) [Towards Multimodal Question Answering in Educational Domain](https://openreview.net/forum?id=lT9xK9pfLp)
23) [MultiCAT: Multimodal Communication Annotations for Teams](https://openreview.net/forum?id=labT01N7sb)
24) [CONSTRUCTURE: Benchmarking CONcept STRUCTUre REasoning for Multimodal Large Language Models](https://openreview.net/forum?id=oFq2Pn8Xqr)
25) [Global Reward to Local Rewards: Multimodal-Guided Decomposition for Improving Dialogue Agents](https://openreview.net/forum?id=qAXUZFU6Q9)
